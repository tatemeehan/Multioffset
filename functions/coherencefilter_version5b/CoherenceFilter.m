...
%     end        
    ...
    % Save Time-Step as Image
%     imwrite(u,bone,['C:\Users\RDCRLTGM\Pictures\vangogh_',num2str(t),'.png'],'png')
% GIF{iter} = u;
% if (t >= (Options.T-0.001))
%     % Create Gif
%     filename = "C:\Users\RDCRLTGM\Pictures\vanGif.gif"; % Specify the output file name
% for idx = 1:iter
%     A = (GIF{idx});
%     map = bone;
%     if idx == 1
%         imwrite(A,map,filename,"gif","LoopCount",Inf,"DelayTime",0.00005);
%     else
%         imwrite(A,map,filename,"gif","WriteMode","append","DelayTime",0.00005);
%     end
% end
% end
% iter = iter+1;
